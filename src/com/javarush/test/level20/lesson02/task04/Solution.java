...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            loadedObject.i = 6;
            loadedObject.j = 7;
            System.out.println("class "+classWithStatic.i+" "+classWithStatic.j+" "+classWithStatic.staticString);
            System.out.println("loaded "+loadedObject.i+" "+loadedObject.j+" "+loadedObject.staticString);
