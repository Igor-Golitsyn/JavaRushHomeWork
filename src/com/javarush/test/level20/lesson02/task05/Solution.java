...
public class Solution {
    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            prop.put("string1",string1.number+"");
            prop.put("string2",string2.number+"");
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            countStrings=Integer.parseInt(prop.getProperty("string1"))-1;
            string1=new String();
            countStrings=Integer.parseInt(prop.getProperty("string2"))-1;
            string2=new String();
            countStrings=temp;
        }
    }
