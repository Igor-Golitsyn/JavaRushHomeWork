    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                int rezult;
                rezult=((String)stock1.get("name")).compareTo((String)stock2.get("name"));
                if (rezult==0){
                    rezult=((Date)(stock2.get("date"))).compareTo((Date)(stock1.get("date")));
                }
                if (rezult==0){
                    Double stock1Pribyl=stock1.containsKey("open") ?
                            ((Double) (stock1.get("last"))-(Double) (stock1.get("open"))):((Double) stock1.get("change"));
                    Double stock2Pribyl=stock2.containsKey("open") ?
                            ((Double) (stock2.get("last"))-(Double) (stock2.get("open"))):((Double) stock2.get("change"));
                    rezult=Double.compare(stock2Pribyl,stock1Pribyl);
                }
                return rezult;
            }
        });
