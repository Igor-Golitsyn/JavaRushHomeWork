...
public class Solution {
    ...
    public static void readKeyFromConsoleAndInitPlanet() {
        ...
        String inputPlanet = null;
        try {
            inputPlanet = reader.readLine();
        } catch (IOException e) {
            e.printStackTrace();
        }
        if (inputPlanet.equals(Planet.EARTH)) thePlanet = Earth.getInstance();
        else if (inputPlanet.equals(Planet.MOON)) thePlanet = Moon.getInstance();
        else if (inputPlanet.equals(Planet.SUN)) thePlanet = Sun.getInstance();
        else thePlanet = null;
