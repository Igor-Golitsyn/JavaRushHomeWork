...
public class Solution {
    ...
    public void sendPost(String url, String urlParameters) throws Exception {
        ...
        request.setEntity(new UrlEncodedFormEntity(getNameValuePair(urlParameters)));
    ...
    private List<NameValuePair> getNameValuePair(String string) {
        List<NameValuePair> nameValuePairs = new ArrayList<>();
        String[] pairs = string.split("&");
        for (String pair : pairs) {
            nameValuePairs.add(new BasicNameValuePair(pair.substring(0, pair.indexOf("=")), pair.substring(pair.indexOf("=") + 1)));
        }
