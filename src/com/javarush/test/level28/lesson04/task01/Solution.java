...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory {
        ...
        private int numberFactory;
        private AtomicInteger numberThread = new AtomicInteger(0);
        public AmigoThreadFactory() {
            numberFactory = countFactory.incrementAndGet();
        }
        @Override
        public Thread newThread(Runnable r) {
            String name = String.format("%s-pool-%d-thread-%d", Thread.currentThread().getThreadGroup().getName(), numberFactory, numberThread.incrementAndGet());
