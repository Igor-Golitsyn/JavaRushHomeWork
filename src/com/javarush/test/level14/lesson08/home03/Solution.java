...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        Person person = null;
        String key = null;
        Set<String> tipWork = new HashSet<>();
        tipWork.add("user");
        tipWork.add("looser");
        tipWork.add("coder");
        tipWork.add("proger");
        ...
        for (String temp : wokers) {
            if (temp.equals("user")) person = new Person.User();
            if (temp.equals("looser")) person = new Person.Looser();
            if (temp.equals("coder")) person = new Person.Coder();
            if (temp.equals("proger")) person = new Person.Proger();
