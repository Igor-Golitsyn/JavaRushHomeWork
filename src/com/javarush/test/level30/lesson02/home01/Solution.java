...
public class Solution {
    public static void main(String[] args) {
        ...
        Number result1 = convertNumberToOtherNumerationSystem(number, NumerationSystemType._10);
        System.out.println(result1);    //expected 110
    }
    public static Number convertNumberToOtherNumerationSystem(Number number, NumerationSystem expectedNumerationSystem) {
        BigInteger temp =new BigInteger(number.getDigit(), number.getNumerationSystem().getNumerationSystemIntValue());
        Number rezult = new Number(expectedNumerationSystem, temp.toString(expectedNumerationSystem.getNumerationSystemIntValue()) );
        return rezult;
    }
}
